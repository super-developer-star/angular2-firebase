...
A simple Todo app example built with **Angular2** and **AngularFire2**. The app features a **Firebase** backend with **OAuth** authentication.
...
```shell
$ git clone https://github.com/webstar775/angular2-firebase.git
$ cd angular2-firebase
$ npm install
$ npm start
```
